...
public class GetLowestPricedOffersSkuIdentifier extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "GetLowestPricedOffersSkuIdentifier",this);
    }

    /** Value constructor. */
    public GetLowestPricedOffersSkuIdentifier(String marketplaceId,String sellerSKU,String itemCondition) {
        this.marketplaceId = marketplaceId;
        this.sellerSKU = sellerSKU;
        this.itemCondition = itemCondition;
    }    
