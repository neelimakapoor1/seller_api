...
public class GetLowestPricedOffersAsinIdentifier extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "GetLowestPricedOffersAsinIdentifier",this);
    }

    /** Value constructor. */
    public GetLowestPricedOffersAsinIdentifier(String marketplaceId,String asin,String itemCondition) {
        this.marketplaceId = marketplaceId;
        this.asin = asin;
        this.itemCondition = itemCondition;
    }    
