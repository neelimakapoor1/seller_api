 ...
 *             &lt;element name="PriceToEstimateFees" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}PriceToEstimateFees"/&gt;
...
public class FeesEstimateRequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "FeesEstimateRequest",this);
    }

    /** Value constructor. */
    public FeesEstimateRequest(String marketplaceId,String idType,String idValue,PriceToEstimateFees priceToEstimateFees,String identifier) {
        this.marketplaceId = marketplaceId;
        this.idType = idType;
        this.idValue = idValue;
        this.priceToEstimateFees = priceToEstimateFees;
