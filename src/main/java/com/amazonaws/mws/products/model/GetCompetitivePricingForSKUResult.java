...
public class GetCompetitivePricingForSKUResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "GetCompetitivePricingForSKUResult",this);
    }

    /** Value constructor. */
    public GetCompetitivePricingForSKUResult(String status) {
        this.status = status;
    }    
