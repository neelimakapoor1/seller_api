 ...
 *             &lt;element name="Product" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}Product" minOccurs="0"/&gt;
...
public class GetLowestOfferListingsForSKUResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "GetLowestOfferListingsForSKUResult",this);
    }

    /** Value constructor. */
    public GetLowestOfferListingsForSKUResult(String status) {
        this.status = status;
    }    
