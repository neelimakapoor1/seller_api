...
public class ASINOfferDetail extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "ASINOfferDetail",this);
    }

    /** Value constructor. */
    public ASINOfferDetail(String subCondition,DetailedShippingTimeType shippingTime,MoneyType listingPrice,MoneyType shipping,boolean isFulfilledByAmazon) {
        this.subCondition = subCondition;
        this.shippingTime = shippingTime;
        this.listingPrice = listingPrice;
        this.shipping = shipping;
