 ...
 *             &lt;element name="SellerFeedbackRating" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}SellerFeedbackType" minOccurs="0"/&gt;
 *             &lt;element name="ShippingTime" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}DetailedShippingTimeType"/&gt;
 *             &lt;element name="ListingPrice" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}MoneyType"/&gt;
 *             &lt;element name="Points" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}Points" minOccurs="0"/&gt;
 *             &lt;element name="Shipping" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}MoneyType"/&gt;
 *             &lt;element name="ShipsFrom" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}ShipsFromType" minOccurs="0"/&gt;
...
public class SKUOfferDetail extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "SKUOfferDetail",this);
    }

    /** Value constructor. */
    public SKUOfferDetail(boolean myOffer,String subCondition,DetailedShippingTimeType shippingTime,MoneyType listingPrice,MoneyType shipping,boolean isFulfilledByAmazon) {
        this.myOffer = myOffer;
        this.subCondition = subCondition;
        this.shippingTime = shippingTime;
        this.listingPrice = listingPrice;
