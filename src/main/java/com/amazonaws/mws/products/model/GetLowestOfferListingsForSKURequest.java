 ...
 *             &lt;element name="SellerSKUList" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}SellerSKUListType"/&gt;
...
public class GetLowestOfferListingsForSKURequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "GetLowestOfferListingsForSKURequest",this);
    }

    /** Value constructor. */
    public GetLowestOfferListingsForSKURequest(String sellerId,String marketplaceId,SellerSKUListType sellerSKUList) {
        this.sellerId = sellerId;
        this.marketplaceId = marketplaceId;
        this.sellerSKUList = sellerSKUList;
    }    
