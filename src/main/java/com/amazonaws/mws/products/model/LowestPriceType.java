 ...
 *          &lt;sequence&gt;
 *             &lt;element name="LandedPrice" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}MoneyType"/&gt;
...
public class LowestPriceType extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "LowestPriceType",this);
    }

    /** Value constructor. */
    public LowestPriceType(String condition,String fulfillmentChannel,MoneyType landedPrice,MoneyType listingPrice,MoneyType shipping) {
        this.condition = condition;
        this.fulfillmentChannel = fulfillmentChannel;
        this.landedPrice = landedPrice;
        this.listingPrice = listingPrice;
