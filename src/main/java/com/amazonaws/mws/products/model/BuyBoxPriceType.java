...
public class BuyBoxPriceType extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "BuyBoxPriceType",this);
    }

    /** Value constructor. */
    public BuyBoxPriceType(String condition,MoneyType landedPrice,MoneyType listingPrice,MoneyType shipping) {
        this.condition = condition;
        this.landedPrice = landedPrice;
        this.listingPrice = listingPrice;
        this.shipping = shipping;
