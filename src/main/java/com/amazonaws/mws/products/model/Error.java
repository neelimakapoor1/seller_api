 ...
 *             &lt;element name="Detail" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}Error.Detail"/&gt;
 *          &lt;/sequence&gt;
 *       &lt;/restriction&gt;
 *    &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Error extends AbstractMwsObject {
    ...
    @Override
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "Error",this);
    }
