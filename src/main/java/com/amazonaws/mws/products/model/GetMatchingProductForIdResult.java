 ...
 *          &lt;sequence&gt;
 *             &lt;element name="Products" type="{http://mws.amazonaws.com/schema/Products/2011-10-01}ProductList" minOccurs="0"/&gt;
...
public class GetMatchingProductForIdResult extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "GetMatchingProductForIdResult",this);
    }

    /** Value constructor. */
    public GetMatchingProductForIdResult(String status) {
        this.status = status;
    }    
