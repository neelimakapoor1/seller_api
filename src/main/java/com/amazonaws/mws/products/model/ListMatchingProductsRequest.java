...
public class ListMatchingProductsRequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonaws.com/schema/Products/2011-10-01", "ListMatchingProductsRequest",this);
    }

    /** Value constructor. */
    public ListMatchingProductsRequest(String sellerId,String marketplaceId,String query) {
        this.sellerId = sellerId;
        this.marketplaceId = marketplaceId;
        this.query = query;
    }    
